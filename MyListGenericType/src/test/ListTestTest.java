...
public class ListTestTest {
    ...
    public void testIsEmpty() {
        List<Integer> list = new ListUptc<>();
    ...
    public void testAdd2() {
        ...
        for(int i = 0;i<10050000;i++){
            list.add("value: " + i);   //2 seg ListUptc
        }
    ...
    public void testAddIndexOut1() {
        ...
        list.add("2");
        list.add("3");
        assertThrows(IndexOutOfBoundsException.class,()->{list.add(10, "a");});
    }
    @Test
    ...
    public void testSize() {
        ...
        assertThrows(IndexOutOfBoundsException.class,()->{list.remove(39);});
    ...
    public void testListIteratorSetException(){
        List list = new ListUptc();
        ListIterator listIterator = list.listIterator();
        ListIterator finalListIterator = listIterator;
        assertThrows(IllegalStateException.class,()->{
            finalListIterator.set("aaa");});
        list = new ListUptc();
        list.add("1111");
        listIterator = list.listIterator();
    ...
    public void testListIteratorIndex() {
        ...
        assertThrows(IndexOutOfBoundsException.class,()->{list.listIterator(23);});
        System.out.println(listIterator.next());
    }
    ...
    @Test
    public void testListIteratorWithIdx(){
        List listUptc = new ArrayList();
        ListIterator it;
        listUptc.add("223");
        listUptc.add("sasac");
        listUptc.add("da");
        it = listUptc.listIterator();
        ...
        for (int i = 0; i < listUptc.size(); i++) {
            System.out.println("Elementos lista antes:" + listUptc.get(i));
        }
        ...
        for (int i = 0; i < listUptc.size(); i++) {
            System.out.println("Elementos lista despues:" + listUptc.get(i));
        }
